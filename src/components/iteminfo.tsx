...
import { Button, Container, Row, Col, Card, ListGroup, Accordion, Table,Modal,Spinner } from "react-bootstrap";
...
const Buynft = () => {
  ...
  const getTokenUri = async () => {
    ...
    axios.get(tokenUri.uri).then((response) => {
      ...
      Api.get(`http://localhost:5000/getUser/${data.nftOwner.slice(2,)}`).then((response) => {
